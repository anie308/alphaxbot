...
function Navbar() {
  ...
  return (
    <div className="bg-[#081428] sticky w-full z-40 top-0 h-[80px] flex items-center justify-center">
      <div className="bg-[#081428] w-full lg:p-[20px_35px] flex flex-col lg:flex-row items-center justify-between 2xl:container">
        ...
        >
          ...
          <button
            ...
            className="bg-[#6942E2] text-white p-[8px_30px] rounded-[6px]"
          >
            Join us
          </button>
        </div>
